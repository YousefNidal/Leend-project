...
const Giftcard = ({giftcardName, cardNumber, howmuch}) => {
  ...
  return (
    <li className='flex items-center justify-between px-3'>
                          <div>
                            <p className={`text-base ${lightTheme==="light"? "text-[#1F2937]" : "text-white"} font-medium`}>{giftcardName}</p>
                            <p className={`text-sm ${lightTheme==="light"? "text-[#4B5563]" : "text-[#9CA3AF]"}`}>{cardNumber}</p>
                          </div>
                          <div className='flex items-center gap-3'>
                            <p className={`${lightTheme==="light"? "text-[#1F2937]" : "text-white"}`}>{howmuch}</p>
                            <span className=' cursor-pointer '>
                              {lightTheme ==="light"? <svg width="10" height="10" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
